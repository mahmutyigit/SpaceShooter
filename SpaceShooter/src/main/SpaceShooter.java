...
public class SpaceShooter extends PApplet {
	...
	public static PImage bg, playerImage,enemyImage, playerLaserImage, enemyLaserImage,diedImage ;
	...
	public void setup() {
		...
		diedImage = loadImage("res/died.png");
		
		player = new Player(this,tag_player, playerImage, width / 2 - playerImage.width / 2, height - playerImage.height, 1.5f);
